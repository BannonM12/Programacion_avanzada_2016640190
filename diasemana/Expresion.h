...
struct  Expresion{
    ...
    Box *BoxOperador;
    static Box *BoxIgual;
    long longMaxAlturaDBox;  //Atributo caluclado
    static COORD COORD_C; // posición del cursor cuando se inicia y "durante"
...
struct Box{
    ...
    virtual void set_coord(COORD c)=0;  //función virtual pura
